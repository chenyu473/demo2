...
public class MobileCodeWS extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(cn.com.webxml.MobileCodeWS.class.getName());
	...
	static {
		...
		try {
			...
			logger.warning("Failed to create URL for the wsdl Location: 'http://ws.webxml.com.cn/WebServices/MobileCodeWS.asmx?wsdl', retrying as a local file");
	...
	public MobileCodeWS() {
		super(MOBILECODEWS_WSDL_LOCATION, new QName("http://WebXml.com.cn/",
				"MobileCodeWS"));
	}
	...
	public MobileCodeWSSoap getMobileCodeWSSoap() {
		return super.getPort(new QName("http://WebXml.com.cn/",
				"MobileCodeWSSoap"), MobileCodeWSSoap.class);
	}
	...
	public MobileCodeWSSoap getMobileCodeWSSoap12() {
		return super.getPort(new QName("http://WebXml.com.cn/",
				"MobileCodeWSSoap12"), MobileCodeWSSoap.class);
	}
	...
	public MobileCodeWSHttpGet getMobileCodeWSHttpGet() {
		return super.getPort(new QName("http://WebXml.com.cn/",
				"MobileCodeWSHttpGet"), MobileCodeWSHttpGet.class);
	}
	...
	public MobileCodeWSHttpPost getMobileCodeWSHttpPost() {
		return super.getPort(new QName("http://WebXml.com.cn/",
				"MobileCodeWSHttpPost"), MobileCodeWSHttpPost.class);
	}
